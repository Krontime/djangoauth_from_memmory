...
SECRET_KEY = 'im5b=@6#i9jl-=7d$tt1k#@o6nc0l2kh4yfsfxb&w^_gbr7w2v'
...
MIDDLEWARE = [
    ...
    'whitenoise.middlewear.WhiteNoiseMiddleware',
]
...
DATABASES = {
    'default': dj_database_url.parse(os.environ.get("DATABASES_URL", "sqlite:///db.sqlite3"))
}
